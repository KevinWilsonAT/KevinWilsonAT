...
<table width="100%">
    ...
    <tbody>
        ...
        <tr title="Curso de Inteligência Artificial - Estudonauta">
            ...
            <td> <!----> </td> <td> 09/24 </td> <td> <!-- fim --> </td> <td> ⏩📖 - Estudando (59%) </td>
        </tr>
        <tr title="Curso de Inglês Básico: Módulo 3 - Curso Em Vídeo"> 
            ...
            <td> 20h </td> <td> 09/24 </td> <td> <!-- fim --> </td> <td> ⏩📖 - Estudando (81%) </td>
        </tr>
        ...
        <tr title="Curso de Kotlin: Módulo 01 - Estudonauta">
            <td> <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/kotlin/kotlin-original.svg" width="16px" height="16px"/> Curso de Kotlin - Módulo 01 </td> <td>  </td> <td> 10/24 </td> <td>  </td> <td> ⏩📖 - Estudando (26%) </td>
        </tr>
        <!--
